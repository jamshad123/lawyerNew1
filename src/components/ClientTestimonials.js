...
const ClientTestimonials = () => {
  return (
    ...
    <Card style={{backgroundColor:"white",borderRadius:"20px",width:"350px",height:"300px",marginRight:"85px"}}>
      <Card.Body>
        <Row>
          <Col xs={6} md={4}>
    ...
    <Card style={{backgroundColor:"white",borderRadius:"20px",width:"350px",height:"300px"}}>
      <Card.Body>
        <Row>
          <Col xs={6} md={4}>
